...
/**
 * Created by zhangpan on 2018/6/27.
 */
...
public class AdjustLinearLayout extends LinearLayout {
    ...
    public AdjustLinearLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AdjustLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
