...
public class StickyNavLayout extends LinearLayout {
	...
	protected void onFinishInflate() {
		...
		if(getChildCount()!=3){
			throw new RuntimeException("should include 3 child and the third view show be ViewPager");
		}
		mTop = getChildAt(0);
		mNav = getChildAt(1);
		...
		if (!(view instanceof ViewPager)) {
			throw new RuntimeException(
					"the third view show be ViewPager !");
		}
	...
	private void getCurrentScrollView() {
		...
		if (a instanceof FragmentPagerAdapter) {
			...
			if(view instanceof ListView || view instanceof ScrollView){
				...
				if(((ViewGroup)view).getChildAt(0) instanceof ViewGroup){
					mInnerScrollView = (ViewGroup) ((ViewGroup)view).getChildAt(0);
				}
				else{
